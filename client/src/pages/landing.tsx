...
const faqItems = [
  ["Who is Practably for?", "Practably is designed for independent fitness coaches who want one place to manage a small client roster, sessions, forms, invoices, and payment workflows."],
    ...
    <div className="mx-auto mt-12 max-w-5xl rounded-[1.75rem] border border-slate-200 bg-white p-2 shadow-2xl shadow-violet-200/50 sm:p-3">
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-slate-50">
        <div className="flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3 sm:px-5">
          <div className="flex items-center gap-2 font-bold text-slate-950"><span className="grid h-7 w-7 place-items-center rounded-lg bg-gradient-to-br from-violet-600 to-orange-500 text-white"><Dumbbell className="h-3.5 w-3.5" aria-hidden="true" /></span>Practably</div>
...
export default function Landing() {
  ...
  useEffect(() => {
    ...
    document.title = "Practably | Coaching Business Software for Independent Fitness Coaches";
    setMeta("description", siteConfig.description);
    setMeta("og:title", "Practably | Coaching Business Software for Independent Fitness Coaches", "property");
    setMeta("og:description", siteConfig.description, "property");
    setMeta("og:type", "website", "property");
    setMeta("og:image", `${siteUrl}/practably-social.svg`, "property");
    setMeta("twitter:card", "summary");
    setMeta("twitter:title", "Practably | Coaching Business Software for Independent Fitness Coaches");
    ...
    <div className="min-h-screen overflow-x-hidden bg-white text-slate-900">
      <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 sm:px-6">
          <a href="/" className="flex items-center gap-2 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500"><span className="grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-violet-600 to-orange-500 text-white shadow-sm"><Dumbbell className="h-4 w-4" aria-hidden="true" /></span><span className="font-extrabold tracking-tight">Practably</span></a>
      ...
      <footer className="bg-slate-950 text-slate-300"><div className="mx-auto flex max-w-6xl flex-col gap-5 px-5 py-8 sm:px-6 md:flex-row md:items-center md:justify-between"><div className="flex items-center gap-2"><span className="grid h-7 w-7 place-items-center rounded-lg bg-gradient-to-br from-violet-600 to-orange-500 text-white"><Dumbbell className="h-3.5 w-3.5" aria-hidden="true" /></span><span className="font-bold text-white">Practably</span></div><p className="text-sm text-slate-400">Built for independent coaches in the UK.</p><nav aria-label="Footer navigation" className="flex flex-wrap gap-5 text-sm font-medium"><Link href="/privacy" className="rounded hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400">Privacy</Link><Link href="/terms" className="rounded hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400">Terms</Link><Link href="/support" className="rounded hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400">Support</Link></nav></div></footer>
    </div>
  );
}